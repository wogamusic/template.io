...
export type FileItem = { id: FileItemId; locked: boolean; name: string; notes: string; channel: number; base_delay: number; avg_delay: number; vep_out: string; vep_instance: string; smp_number: string; smp_instance: string; smp_out: string; color: string }
export type FileItemRequest = { id: FileItemId; locked?: boolean | null; name?: string | null; notes?: string | null; channel?: number | null; base_delay?: number | null; avg_delay?: number | null; vep_out?: string | null; vep_instance?: string | null; smp_number?: string | null; smp_instance?: string | null; smp_out?: string | null; color?: string | null }
...
export type FullTrackForExport = ({ id: FileItemId; locked: boolean; name: string; notes: string; channel: number; base_delay: number; avg_delay: number; vep_out: string; vep_instance: string; smp_number: string; smp_instance: string; smp_out: string; color: string }) & { full_ranges: ItemsFullRanges[]; fad_list: ItemsFadList[]; art_list_tog: ItemsArtListTog[]; art_list_tap: ItemsArtListTap[]; art_layers: ItemsArtLayers[] }
export type FullTrackListForExport = { file_meta_data: FileMetadata; items: FullTrackForExport[] }
export type FullTrackWithCounts = ({ id: FileItemId; locked: boolean; name: string; notes: string; channel: number; base_delay: number; avg_delay: number; vep_out: string; vep_instance: string; smp_number: string; smp_instance: string; smp_out: string; color: string }) & { _count: FullTrackCounts }
...
export type Settings = { vep_out_settings: number; smp_out_settings: number; default_range_count: number; default_art_tog_count: number; default_art_tap_count: number; default_art_layer_count: number; default_fad_count: number; default_art_tog_code_type: string; default_art_tap_code_type: string; default_art_layer_code_type: string; default_fad_code_type: string; default_art_tog_code: number; default_art_tap_code: number; default_art_layer_code: number; default_fad_code: number; track_add_count: number; sub_item_add_count: number; selected_item_id: FileItemId; selected_sub_item_id: SubItemId; previous_item_id?: FileItemId | null; next_item_id?: FileItemId | null; track_options_layouts: TrackOptionLayouts; default_colors: string[]; sampler_list: string[]; vep_instance_list: string[]; middle_c: string }
