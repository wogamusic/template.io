...
pub struct Settings {
  ...
  pub default_art_tog_code_type: String,
  pub default_art_tap_code_type: String,
  pub default_art_layer_code_type: String,
  pub default_fad_code_type: String,
  pub default_art_tog_code: i32,
  pub default_art_tap_code: i32,
  pub default_art_layer_code: i32,
  pub default_fad_code: i32,
...
pub fn init_settings() -> Settings {
  Settings {
    ...
    default_fad_count: 4,
    default_art_tog_code_type: "/control".to_string(),
    default_art_tap_code_type: "/control".to_string(),
    default_art_layer_code_type: "/control".to_string(),
    default_fad_code_type: "/control".to_string(),
    default_art_tog_code: 0,
    default_art_tap_code: 0,
    default_art_layer_code: 0,
    default_fad_code: 0,
    track_add_count: 1,
